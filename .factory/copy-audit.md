...
and small club operators. Try it with sample data.” This states the job,
audience, and first action in one breath.

## Product preview and steps
...
| 6 Apr – 5 Jul 2026 | 5 |
| Capture; Match; Review; Export | 4 |
| Quarter record; 6 transactions; 2 need evidence | 7 |
| Teaching card supplies; Materials · £32.99; Evidence linked | 7 |
| Train to client session; Travel · £27.80; Evidence missing | 8 |
| Spring maths tutoring; Invoice INV-026 · £120.00; Evidence linked | 8 |
| How it works | 3 |
...
| Receipt and invoice evidence; Bank CSV review; Accountant evidence packs | 10 |
...
| Version 1.0 · Build 2026.08 · Generated hero imagery is original to this product. | 12 |
...
- Catalog description: “Link transactions to evidence and export a quarter pack before your MTD update.” It is 12 words, 78 characters, and verb first.
